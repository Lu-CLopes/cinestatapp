...
class DeleteMovieVariablesBuilder {
  ...
  DeleteMovieVariablesBuilder(this._dataConnect, {required  this.movieId,});
  Deserializer<DeleteMovieData> dataDeserializer = (dynamic json)  => DeleteMovieData.fromJson(jsonDecode(json));
  ...
  MutationRef<DeleteMovieData, DeleteMovieVariables> ref() {
    DeleteMovieVariables vars= DeleteMovieVariables(movieId: movieId,);
    return _dataConnect.mutation("DeleteMovie", dataDeserializer, varsSerializer, vars);
  }
}
...
class DeleteMovieData {
  ...
  movie_delete = json['movie_delete'] == null ? null : DeleteMovieMovieDelete.fromJson(json['movie_delete']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
